...
# # MongoDB client (for chat messages + OCR cache)
# mongodb_client = None
# database = None
...
#     print("✅ Local MongoDB connected (chat + OCR cache)")
...
# # ─────────────────────────────────────────────
# # OCR CACHE — local MongoDB
# # ─────────────────────────────────────────────

# async def _get_cached_ocr(assignment_id: str) -> Optional[str]:
#     """Local MongoDB থেকে cached OCR text আনো"""
#     try:
#         if database is None:
#             return None
...
#     """OCR result local MongoDB তে save করো"""
#     try:
#         if database is None:
#             return
#         col = database["assignment_ocr_cache"]
...
#     """
#     1. Remote API থেকে assignment আনে
#     2. Cache check করে — থাকলে OCR skip
#     3. না থাকলে PDF OCR করে cache এ save করে
#     4. instructions + OCR text মিলিয়ে full_text বানায়
#     """
#     try:
#         async with httpx.AsyncClient(timeout=TIMEOUT) as client:
...
#         if pdf_text is None:
#             # Cache miss → OCR করো এবং save করো
