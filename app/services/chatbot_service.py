...
#     # Check if answer is long and detailed (likely a full solution)
#     is_detailed = len(answer) > 600
    
#     # Only suggest if it's a full solution
#     return has_solution and is_detailed
